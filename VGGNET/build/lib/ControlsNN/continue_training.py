...
def continue_training(dataset_path, epoch, bs):
	...
	model.save(os.path.abspath("venv/lib/python3.7/site-packages/ControlsNN/vggnet.model"))
	f = open(os.path.abspath("venv/lib/python3.7/site-packages/ControlsNN/vggnet_lb.pickle"), "wb")
